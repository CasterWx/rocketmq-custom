    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            ...
            this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
                ...
                public void run() {
                    try {
                        log.info("【5s】offset记录-内存持久化到文件...start");
                        BrokerController.this.consumerOffsetManager.persist();
                        log.info("【5s】offset记录-内存持久化到文件...end");
                    } catch (Throwable e) {
                        log.info("schedule persist consumerOffset error.", e);
                    }
                }
            ...
            this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
                ...
                public void run() {
                    try {
                        log.info("【10s】filter记录-内存持久化到文件...start");
            ...
            this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
                ...
                public void run() {
                    try {
                        log.info("【3s】开始检查broker消费进度...start");
                        BrokerController.this.protectBroker();
                        log.info("【3s】检查broker消费进度...end");
                    } catch (Throwable e) {
            ...
            if (BrokerRole.SLAVE == this.messageStoreConfig.getBrokerRole()) {
                ...
                this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
                    ...
                    public void run() {
                        try {
                            System.out.println("【10s】【SLAVE节点】同步元数据等信息....start");
                            BrokerController.this.slaveSynchronize.syncAll();
                            System.out.println("【10s】【SLAVE节点】同步元数据等信息....end");
                        } catch (Throwable e) {
