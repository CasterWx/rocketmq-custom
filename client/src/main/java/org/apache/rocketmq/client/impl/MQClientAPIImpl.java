...
public class MQClientAPIImpl {
    ...
    private SendResult sendMessageSync(
        ...
        System.out.println("#### addr:" + addr +", brokerName:" + brokerName + ", msg"+msg.toString()+", realTimeout:" + timeoutMillis + ", request:"+request.toString());
        RemotingCommand response = this.remotingClient.invokeSync(addr, request, timeoutMillis);
        System.out.println("#### 响应, response:"+response.toString());
        assert response != null;
